...
namespace MyHook
{
    ...
    BYTE g_RegionSig[58] = {
        ...
        0x45,0xD8,0x68,0x28,0xA1,0xA3,0x00,0x8D,
        0x55,0xD8,0x89,0x45,0xFC,0x8D,0x4D,0xC0,
        0xE8,0x14,0xE9,0xF0,0xFF,0x83,0xC4,0x04,
        0xC6,0x45,0xFC,0x02,0x83,0x7D,0xEC,0x08,
        0x72,0x0B
    };

    BYTE g_RegionPatch[6] = { 0xE9,0x31,0x02,0x00,0x00,0x90 };  // jmp 006007C5; nop
