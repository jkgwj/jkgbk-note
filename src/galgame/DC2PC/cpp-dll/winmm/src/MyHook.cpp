...
namespace MyHook
{
    ...
    // 过序列号验证
    BYTE g_SerialSig[] = { 0x83, 0xEC, 0x18, 0xA1, 0xD8, 0xA5, 0x54, 0x00 };
    ...
    // 过KEY验证
    BYTE g_KeySig[] = { 0x81, 0xEC, 0x08, 0x04, 0x00, 0x00, 0xA1, 0xD8, 0xA5, 0x54, 0x00 };
    ...
    {
        g_BaseAddr = (DWORD)::GetModuleHandleW(L"dc2pc.exe");
